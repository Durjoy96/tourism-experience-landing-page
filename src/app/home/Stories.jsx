    ...
    <div className="max-w-7xl mx-auto px-5 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-0">
      <div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="grid gap-6 md:gap-8 mt-8 md:mt-16"
        >
          <CustomersFeedback
            img={WomenCustomer}
            name="amara t."
      ...
      <div className="flex justify-end md:justify-center lg:justify-end">
        <motion.div
          ...
          transition={{ duration: 0.8 }}
          viewport={{ once: true }}
          className="max-w-[300px] md:max-w-md h-[350px] md:h-[448px] relative"
        >
          <Image
            src={happyMemories}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-[150px] h-[150px] md:w-[200px] md:h-[200px] bg-primary-content absolute -bottom-[80px] -left-[20px] px-4 md:px-6 py-6 md:py-8 flex flex-col justify-between"
          >
