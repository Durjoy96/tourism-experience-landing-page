    ...
    >
      <div className="max-w-7xl mx-auto px-5 py-12 relative h-full">
        <h3 className="text-white/90 max-w-lg text-2xl font-medium">
          ...
          experiences, travel inspiration, and insider tips - delivered straight
          to your inbox.
        </h3>
        {/* form */}
        <div
          id="formContainer"
          className="bg-primary-content pt-6 pb-4 px-3 w-[520px] absolute bottom-0 left-1/2 -translate-x-1/2 flex items-center flex-col"
        >
